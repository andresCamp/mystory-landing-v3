  ...
  return (
    <div>
        <div className='flex flex-col items-center gap-12 my-48'>
            ...
            <div className='flex flex-col items-center gap-12 bg-[#DEDFCD] rounded-3xl px-20 py-4 shadow-xl'>
                ...
                <div className='flex flex-row gap-3 items-first justify-center'>
                    <React.Fragment>
